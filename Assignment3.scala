...
object Assignment3 extends App{
  println("----- 1. Determining if the given number is a prime number -----")
  ...
  println("\n----------------------------------------------------------------------------")
  println("----- 2. Printing all prime numbers less than a given number -----")
  ...
  println("\n----------------------------------------------------------------------------")
  println("----- 3. Calculating sum of 1 to n numbers -----")
  ...
  println("\n----------------------------------------------------------------------------")
  println("----- 4. Determining if the given number is odd or even -----")
  ...
  println("\n----------------------------------------------------------------------------")
  println("----- 5. Calculating sum of all even numbers less than the given number -----")
  ...
  println("\n----------------------------------------------------------------------------")
  println("----- 6. Printing first Fibonacci numbers for a given number -----")
